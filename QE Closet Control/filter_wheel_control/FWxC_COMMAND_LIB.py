"""
Needs 'FilterWheel102_win64.dll'
Needed for 'wheel_controller.py'
"""
...
_dll_path = os.path.join(os.path.dirname(__file__), "FilterWheel102_win64.dll")
FWxCLib = cdll.LoadLibrary(_dll_path)


"""common command"""
GetPorts = FWxCLib.GetPorts
GetPorts.argtypes = [c_char_p, c_uint]
GetPorts.restype  = c_int

# Alias it so your existing code still works:
FWxCListDevices = GetPorts

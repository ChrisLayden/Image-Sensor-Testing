...
# Open jpg image as numpy array
dark_file = '/Users/layden/Desktop/DarkImageWithOffset.png'
light_file = '/Users/layden/Desktop/LightImageGain48db.png'
dark_img = plt.imread(dark_file)
light_img = plt.imread(light_file)
test_img = dark_img[dark_img > 0]

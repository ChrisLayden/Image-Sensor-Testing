...
month = 1
day = 1
stop_time = datetime.datetime(year=year, month=month, day=day, hour=12, minute=34, second=36, microsecond=1)
exposure_time = 60
start_time = stop_time - datetime.timedelta(seconds=exposure_time)
